...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="javascript:;">
               <!--<img src="<?= base_url('assets/admin/images') ?>/logo-big.png" alt="" />--> 
                </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
...
<!--                    <label class="rememberme mt-checkbox mt-checkbox-outline">
        ...
        <!-- BEGIN COPYRIGHT -->
<!--        <div class="copyright">
            All Rights Reserved © | <a target="_blank" href="http://www.mv-is.com/">Powered By MASTER VISION Integrated Solutions </a>
        </div>-->
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
